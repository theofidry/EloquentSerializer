...
class SymfonyAppTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'wouterj_eloquent' => 'getWouterjEloquentService',
            'wouterj_eloquent.aliases.loader' => 'getWouterjEloquent_Aliases_LoaderService',
            'wouterj_eloquent.database_manager' => 'getWouterjEloquent_DatabaseManagerService',
            'wouterj_eloquent.facade.initializer' => 'getWouterjEloquent_Facade_InitializerService',
            'wouterj_eloquent.initializer' => 'getWouterjEloquent_InitializerService',
            'wouterj_eloquent.migrations.creator' => 'getWouterjEloquent_Migrations_CreatorService',
            'wouterj_eloquent.migrations.repository' => 'getWouterjEloquent_Migrations_RepositoryService',
            'wouterj_eloquent.migrator' => 'getWouterjEloquent_MigratorService',
        );
        $this->aliases = array(
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('wouterj_eloquent.initializer', 'WouterJ\\EloquentBundle\\EventListener\\EloquentInitializer');
        $instance->addSubscriberService('wouterj_eloquent.facade.initializer', 'WouterJ\\EloquentBundle\\EventListener\\FacadeInitializer');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('FidryEloquentSerializerBundleSecret');
    }
    ...
    /**
     * Gets the 'wouterj_eloquent' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getWouterjEloquentService()
    {
        $this->services['wouterj_eloquent'] = $instance = new \Illuminate\Database\Capsule\Manager();

        $instance->addConnection(array('driver' => 'sqlite', 'host' => 'local', 'database' => ($this->targetDirs[2].'/../database.sqlite'), 'username' => 'root', 'password' => NULL, 'prefix' => NULL, 'charset' => 'utf8', 'collation' => 'utf8_unicode_ci'), 'sqlite');

        return $instance;
    }

    /**
     * Gets the 'wouterj_eloquent.aliases.loader' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \WouterJ\EloquentBundle\Facade\AliasesLoader A WouterJ\EloquentBundle\Facade\AliasesLoader instance
     */
    protected function getWouterjEloquent_Aliases_LoaderService()
    {
        return $this->services['wouterj_eloquent.aliases.loader'] = new \WouterJ\EloquentBundle\Facade\AliasesLoader();
    }

    /**
     * Gets the 'wouterj_eloquent.database_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Illuminate\Database\DatabaseManager A Illuminate\Database\DatabaseManager instance
     */
    protected function getWouterjEloquent_DatabaseManagerService()
    {
        $this->services['wouterj_eloquent.database_manager'] = $instance = $this->get('wouterj_eloquent')->getDatabaseManager();

        $instance->setDefaultConnection('sqlite');

        return $instance;
    }

    /**
     * Gets the 'wouterj_eloquent.facade.initializer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \WouterJ\EloquentBundle\EventListener\FacadeInitializer A WouterJ\EloquentBundle\EventListener\FacadeInitializer instance
     */
    protected function getWouterjEloquent_Facade_InitializerService()
    {
        return $this->services['wouterj_eloquent.facade.initializer'] = new \WouterJ\EloquentBundle\EventListener\FacadeInitializer($this);
    }

    /**
     * Gets the 'wouterj_eloquent.initializer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \WouterJ\EloquentBundle\EventListener\EloquentInitializer A WouterJ\EloquentBundle\EventListener\EloquentInitializer instance
     */
    protected function getWouterjEloquent_InitializerService()
    {
        return $this->services['wouterj_eloquent.initializer'] = new \WouterJ\EloquentBundle\EventListener\EloquentInitializer($this->get('wouterj_eloquent'));
    }

    /**
     * Gets the 'wouterj_eloquent.migrations.creator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \WouterJ\EloquentBundle\Migrations\Creator A WouterJ\EloquentBundle\Migrations\Creator instance
     */
    protected function getWouterjEloquent_Migrations_CreatorService()
    {
        return $this->services['wouterj_eloquent.migrations.creator'] = new \WouterJ\EloquentBundle\Migrations\Creator();
    }

    /**
     * Gets the 'wouterj_eloquent.migrations.repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Illuminate\Database\Migrations\DatabaseMigrationRepository A Illuminate\Database\Migrations\DatabaseMigrationRepository instance
     */
    protected function getWouterjEloquent_Migrations_RepositoryService()
    {
        return $this->services['wouterj_eloquent.migrations.repository'] = new \Illuminate\Database\Migrations\DatabaseMigrationRepository($this->get('wouterj_eloquent.database_manager'), 'migrations');
    }

    /**
     * Gets the 'wouterj_eloquent.migrator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \WouterJ\EloquentBundle\Migrations\Migrator A WouterJ\EloquentBundle\Migrations\Migrator instance
     */
    protected function getWouterjEloquent_MigratorService()
    {
        return $this->services['wouterj_eloquent.migrator'] = new \WouterJ\EloquentBundle\Migrations\Migrator($this->get('wouterj_eloquent.migrations.repository'), $this->get('wouterj_eloquent.database_manager'));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FidryEloquentSerializerBundle' => 'Fidry\\EloquentSerializer\\Symfony\\Bundle\\FidryEloquentSerializerBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'SymfonyAppTestDebugProjectContainer',
            'fragment.renderer.hinclude.global_template' => '',
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'FidryEloquentSerializerBundleSecret',
